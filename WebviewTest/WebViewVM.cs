...
{
    public class WebViewVM : NotifiablePropertyModel
    {
...
<blockquote><p> Lorem ipsum dolor sit amet,
                consectetur adipiscing elit.Vivamus magna.Cras in mi at felis aliquet congue.Ut a est eget ligula molestie gravida.Curabitur massa.Donec eleifend,
                libero at sagittis mollis,
...
#header h1 a {
  display: block;
        ...
        height: 80px;
                ...
                BaseUrl = DependencyService.Get<IDevicePath>().GetPath()
            };
        }
    }
}
